...
class PersonalInfo extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    role.text = userModel!.role!.toString();
      ...
      builder: (context, state) => Scaffold(
        ...
        [
          Padding(
            ...
            child: Text("Personal Information", style: TextStyle(fontWeight: FontWeight.w900, fontSize: 35,
              ...
              child: Stack(
                  children: [
                    ClipRRect(
                        ...
                        child: ShaderMask(
                          ...
                          child: ShaderMask(
                            ...
                            child: Image.asset("assets/profile1.gif",
                    ...
                    Positioned(
                      top: 165,
                      left: 10,
                      child: Text("Customize your profile",
          ...
          Padding(
            ...
            child: defTextField(teController: ShopCubit.of(context).nameCon, leadingText: "Name", prefixIcon: FontAwesomeIcons.user,
                type: TextInputType.text, isDisabled: true, context: context),
          ),
          Padding(
            padding: const EdgeInsets.symmetric(vertical: 5, horizontal: 20),
            child: defTextField(teController: role, leadingText: "Role", prefixIcon: FontAwesomeIcons.passport,
                type: TextInputType.text, isDisabled: false, context: context),
          ),
          Padding(
            padding: const EdgeInsets.symmetric(vertical: 5, horizontal: 20),
            child: defTextField(teController: ShopCubit.of(context).avatarCon, leadingText: "Avatar", prefixIcon: FontAwesomeIcons.image,
                type: TextInputType.text, isDisabled: true, context: context),
          ),
          Padding(
            ...
            {
              ShopCubit.of(context).editUserData(userModel.email!, userModel.password!,
